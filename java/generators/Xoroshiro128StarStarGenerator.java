...
public class Xoroshiro128StarStarGenerator implements RandomGenerator64 {
	 ...
	 */
	public Xoroshiro128StarStarGenerator(byte[] seed) {
		setSeed(seed);
	}
	 ...
	 *                      A generator.
	 */
	public Xoroshiro128StarStarGenerator(Xoroshiro128StarStarGenerator generator) {
	...
	public Xoroshiro128StarStarGenerator split() {
		Xoroshiro128StarStarGenerator generator = new Xoroshiro128StarStarGenerator(this);
		generator.jump();
		return generator;
	}
