...
/**
 * Implementation of a well equidistributed long-period linear 44497 A PRNG with
 ...
 *
 */
public class WELL44497AGenerator implements RandomGenerator32 {
	 ...
	 */
	public static final int STATE_SIZE = WELL44497AGenerator.STATE_SIZE_INTEGERS * Integer.BYTES;
	/**
	 * Size of this generator's seed in bytes.
	 */
	public static final int SEED_SIZE = WELL44497AGenerator.STATE_SIZE;
	/**
	 * Size of this generator's state, including the index, in bytes.
	 */
	public static final int FULL_STATE_SIZE = Integer.BYTES + WELL44497AGenerator.STATE_SIZE;
	 ...
	 * seed generator.
	 */
	public WELL44497AGenerator() {
		this(RandomGenerator.DEFAULT_SEED_GENERATOR.generateBytes(WELL44497AGenerator.SEED_SIZE));
	}
	 ...
	 */
	public WELL44497AGenerator(final byte[] seed) {
		this.setSeed(seed);
	}
	...
	public int getSeedSize() {
		return WELL44497AGenerator.SEED_SIZE;
	}

	@Override
	public int getStateSize() {
		return WELL44497AGenerator.FULL_STATE_SIZE;
	}

	@Override
	public void setSeed(final byte[] seed) {
		if (seed.length < WELL44497AGenerator.SEED_SIZE) {
	...
	public void setState(final byte[] state) {
		if (state.length < WELL44497AGenerator.FULL_STATE_SIZE) {
			throw new IllegalArgumentException();
		}
		final byte[] indexBytes = new byte[Integer.BYTES];
		final byte[] stateBytes = new byte[WELL44497AGenerator.STATE_SIZE];
	...
	public int generateUniformInteger() {
		...
		final int index23 = (this.index + 23) % WELL44497AGenerator.STATE_SIZE_INTEGERS;
		final int index229 = (this.index + 229) % WELL44497AGenerator.STATE_SIZE_INTEGERS;
		final int index481 = (this.index + 481) % WELL44497AGenerator.STATE_SIZE_INTEGERS;
		final int index1389 = (this.index + 1389) % WELL44497AGenerator.STATE_SIZE_INTEGERS;
		final int index1390 = (this.index + 1390) % WELL44497AGenerator.STATE_SIZE_INTEGERS;
